...
<div id="header"  class="header">
  ...
  <div class="Search"></div>
		...
		%>
		<form action="updateTeaServlet" method="post"><br/>
			编 号&nbsp;<input type="text" name="tid" value="<%=tea.getTid() %>" readonly/>
			&nbsp;&nbsp;
			名 称&nbsp;<input type="text" name="tname" value="<%=tea.getTname() %>"/>
			<br/><br/><br/>
			价 格&nbsp;<input type="number" name="price" value="<%=format.format(tea.getPrice()) %>"/>
			&nbsp;&nbsp;
			库 存&nbsp;<input type="text" name="stock" value="<%=format.format(tea.getStock()) %>"/>
			<br/><br/><br/>
			图 片&nbsp;<input type="text" name="src" value="<%=tea.getSrc() %>"/>
			&nbsp;&nbsp;
			类 型&nbsp;<input type="text" name="typ" value="<%=tea.getTyp() %>" />
			<br/><br/><br/>
			产 地&nbsp;<input type="text" name="origin" value="<%=tea.getOrigin() %>"/>
			&nbsp;&nbsp;
			描 述&nbsp;<input type="text" name="des" value="<%=tea.getDes() %>"/>
			<br/><br/><br/>
			<input type="submit" value=" 确 认 修 改 " id="submi"/>
			<br/><br/>
		</form>
		<script>
